...
const FloatingDockMobile = ({
  ...
  return (
    (<div className={cn("relative block md:hidden m-6", className)}>
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId="nav"
...
const FloatingDockDesktop = ({
  ...
  return (
    (<motion.div
      ...
      className={cn(
        "mx-auto md:flex hidden h-16 gap-4 items-end rounded-2xl bg-gray-50 dark:bg-neutral-900 px-4 pb-3",
        className
      )}>
      {items.map((item) => (
